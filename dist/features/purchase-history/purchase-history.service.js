...
let PurchaseHistoryService = class PurchaseHistoryService {
    constructor(purchasehistoryRespository) {
        this.purchasehistoryRespository = purchasehistoryRespository;
    }
    ...
    async findCourseHistory(courseId, studentId) {
...
exports.PurchaseHistoryService = PurchaseHistoryService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(purchaseHistor_entity_1.PurchaseHistory)),
